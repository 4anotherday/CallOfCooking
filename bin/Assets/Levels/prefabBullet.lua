...
prefab[4] = { Component = "PlayerBulletBehaviorComponent",Damage=5, MovementSpeed = 200, LifeTime= 5.0}
prefab[5] = { Component = "PlayerBulletBehaviorComponent",Damage=5, MovementSpeed = 200}
