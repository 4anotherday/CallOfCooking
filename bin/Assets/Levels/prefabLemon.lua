...
prefab[1] = { Component = "Transform", Coord = {X = 0, Y = -500, Z = -300},Rotation = {X=0,Y=0,Z=0},Scale = {X=0.3,Y=0.3,Z=0.3}}
...
prefab[5] = { Component = "LemonBehaviorComponent", Range =1, MovementSpeed = 0.2, AttackRate=1}
